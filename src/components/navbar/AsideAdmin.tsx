...
const AsideAdmin = () => {
  ...
  return (
    <div className="invisible relative bg-gray-50 dark:bg-content1 lg:visible">
      <aside className="absolute left-0 top-0 flex h-screen w-[270px] -translate-x-full flex-col overflow-y-hidden  lg:sticky lg:translate-x-0">
        <Link
          href="/admin"
          color="foreground"
